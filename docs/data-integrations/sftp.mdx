...
import SftpCourseCompletedJson from '!!raw-loader!../events/course_completed_sftp.json';
import SftpCourseCompletedCsv from '!!raw-loader!../events/course_completed_sftp.csv';
...
<Tabs>
  ...
  <CodeBlock language="csv" showLineNumbers title="courseCompletion-1589259213_2020-05-18T18-00-13-7vcph2i.csv">{SftpCourseCompletedCsv}</CodeBlock>
  </TabItem>
</Tabs>
