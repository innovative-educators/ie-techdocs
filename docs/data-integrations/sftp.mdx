...
import CourseCompletedJson from '!!raw-loader!../events/course-completed.json';
import CourseCompletedCsv from '!!raw-loader!../events/course-completed.csv';

# SFTP - Events Nightly

## Description
Data from events that occur on the platform can be sent in bulk to your SFTP server every night, where you can then process and/or pass this data onward to any third party system for automation / reporting / analytics purposes.
...
2.  Send your IE representative the SFTP URL where you would like files to be sent. The URL should include a `username`, `password`, `domain`, `port`, and `path`.
...
### Trigger
When a learner completes a course (sent in batch nightly)
...
<Tabs>
  ...
  <CodeBlock language="json" showLineNumbers title="courseCompletion-1589259213_2020-05-18T18-00-13-7vcph2i.json">[{CourseCompletedJson}]</CodeBlock>
  ...
  <CodeBlock language="csv" showLineNumbers title="courseCompletion-1589259213_2020-05-18T18-00-13-7vcph2i.csv">{CourseCompletedCsv}
  ...
  </CodeBlock>
  </TabItem>
</Tabs>
