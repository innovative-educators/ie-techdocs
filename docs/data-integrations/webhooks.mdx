...
import CourseCompletedExample from '!!raw-loader!../events/course_completed.json';
import CourseCertificateGrantedExample from '!!raw-loader!../events/course_certificate_granted.json';
import LearningPathCompletedExample from '!!raw-loader!../events/learning_path_completed.json';
...
### Sample Payload
<CodeBlock language="json">{CourseCertificateGrantedExample}</CodeBlock>
