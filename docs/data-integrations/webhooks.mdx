...
### Sample Payload
<CodeBlock language="json">{CourseCompletedExample}</CodeBlock>
</details>
...
### Sample Payload
<CodeBlock language="json">{LearningPathCompletedExample}</CodeBlock>
</details>
...
<CodeBlock language="json">{QuizAttemptCompletedExample}</CodeBlock>
</details>
...
### Sample Payload
<CodeBlock language="json">{CourseCertificateIssuedExample}</CodeBlock>
