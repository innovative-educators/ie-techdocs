...
import CourseCertificateIssuedExample from '!!raw-loader!../events/course-certificate-issued.json';
...
<details>
<summary>**Learning Path Completed**</summary>
...
{/* <details>
<summary>**Course Certificate Issued(depreciated)**</summary>

### Trigger
When a course certificate should be issued

### Sample Payload
<CodeBlock language="json" showLineNumbers>{CourseCertificateIssuedExample}</CodeBlock>
