...
-   Redirect logout to this URL. You can use {{returnTo}} to include the URL the learner should be returned to after logging out via SSO.
-   Example: https://www.example.com/logout?returnTo={{returnTo}}
...
-   Redirect learners to this URL when they try to change their account or profile settings, such as name, email, or password. You can use {{returnTo}} to include the URL the learner should be returned to after updating their profile.
-   Example: https://www.example.com/settings?returnTo={{returnTo}}
