...
:::warning
The following example has you irroniously strip the domain from the NameID and needs updating. Leaving here for reference until the example can be updated.
:::
